...
func BotCommands() []BotCommand {
	return []BotCommand{
		...
		{Command: "agents", Description: "List spawned sub-agents"},
		{Command: "sessions", Description: "List conversation sessions"},
		{Command: "browse", Description: "Fetch URL content"},
		{Command: "pin", Description: "Pin info to session"},
		{Command: "pins", Description: "List pinned items"},
